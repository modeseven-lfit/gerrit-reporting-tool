...
4. **Test the configuration**:
   ...
   ```bash
   python -m lf_releng_project_reporting.main --project "My Project" --validate-only
   ```
...
```bash
python -m lf_releng_project_reporting.main --project "Your Project" --validate-only
```
