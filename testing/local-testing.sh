...
# Script directory (assuming script is in lf-releng-project-reporting/testing/)
...
download_production_reports() {
    ...
    local github_pages_base="https://lfreleng-actions.github.io/project-reporting-tool"
    local testing_reports_dir="${SCRIPT_DIR}/reports"
...
generate_project_report() {
    ...
    local cmd="uv run lf-releng-project-reporting generate \
