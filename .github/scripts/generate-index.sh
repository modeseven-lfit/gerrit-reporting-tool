...
<body>
  <div class="container">
    ...
    <footer>
      <p>
        Generated by
        <a href="https://github.com/lfit/gerrit-reporting-tool" target="_blank">
